...
<head>
    ...
    <meta name="keywords" content="<?=lang('header.keywords');?>">
    <meta name="author" content="<?=lang('header.author');?>">
    <meta property="og:image" content="<?=base_url();?>img/_old_web/logo_200.png"/>
    <meta property="og:title" content="Emakers"/>
    <meta property="og:description" content="<?=lang('header.description');?>"/>
