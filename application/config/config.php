...
if(strpos($_SERVER['HTTP_HOST'],'emakers-dev-public-web.es') !== false){
	...
	$config['base_url']		= 'https://emakers-dev-public-web.es/';
	$config['ws_base_url'] 	= 'https://emakers-dev-argos-web/ws/server.php?wsdl';
	...
	*/
	...
	$config['base_url']		= 'https://emakers-dev-public-web.co.uk/';
	$config['ws_base_url'] 	= 'https://emakers-dev-argos-web/ws/server.php?wsdl';
	$config['ws_login']		= 'admin@gogentle.es';
	$config['ws_passw']		= 'ciclocargobarna';
	...
	*/
	...
	$config['base_url']		= 'http://www.emakers.es/';
	...
	*/
...
}else if(strpos($_SERVER['HTTP_HOST'],'emakers.co.uk') !== false){
	...
	$config['base_url']		= 'http://www.emakers.co.uk/';
	$config['ws_base_url'] 	= 'http://emks.net/ws/server.php?wsdl';
	$config['ws_login']		= 'admin@gogentle.es';
	$config['ws_passw']		= 'ciclocargobarna';
